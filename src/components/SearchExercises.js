...
const SearchExercises = ({bodyPart, setExercises, setBodyPart}) => {
  ...
  useEffect(() => {
    const fetchExercisesData = async () => {
      ...
      // console.log("🚀 ~ file: SearchExercises.js:14 ~ fetchExercisesData ~ bodyPartsData:", bodyPartsData)
  ...
  const handleSearch = async () => {
    if (search) {
      ...
      // console.log("🚀 ~ file: SearchExercises.js:32 ~ searchedExercises ~ searchedExercises:", searchedExercises)
